...
def main():
    ...
    # Graficar resultados después del loop
    ...
    plt.plot(mpu.gyro_roll_data, label="Roll (Gyroscope)", color='g', linestyle=':')
    ...
    plt.plot(mpu.gyro_pitch_data, label="Pitch (Gyroscope)", color='g', linestyle=':')
